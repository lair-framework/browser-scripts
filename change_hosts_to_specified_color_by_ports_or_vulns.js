var changeHostsToSpecifiedColorByPortsOrVulns = function (portsOrVulns, statusOption, lairColor){
	...
	// Ports or Vulns Options (portsOrVulns)
		// 'ports': Change hosts based on host's ports
		// 'vulns': Change hosts based on host's ports
	//
	...
	// Else if statusOption === 'diff' then change all hosts to specified lairColor, if host has > 1 port and ports have different colors
